        ...
        <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <Card className="border-border/70 bg-linear-to-br from-card via-card to-secondary/65">
            <CardHeader className="space-y-5">
              ...
              <div className="space-y-3">
                <CardTitle className="font-heading text-4xl">
                  Halo, {viewer.name}. Dashboard guru sekarang dibuat seperti alur kerja, bukan tumpukan form.
                </CardTitle>
            ...
            <CardContent className="flex flex-wrap gap-3">
              ...
              <Button asChild variant="outline">
                <Link href="/dashboard/admin?tab=ethics">Tulis kasus etika</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="border-border/70 bg-card/92">
            <CardHeader className="space-y-3">
              ...
              <CardTitle className="text-2xl">Apa yang perlu dicek hari ini?</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm leading-7 text-muted-foreground">
              <div className="rounded-3xl border border-border/70 bg-background/85 p-5">
                ...
                <p className="mt-1">
                  Jika modul sudah punya tujuan belajar dan minimal satu blok, cek ulang lalu publikasikan.
                </p>
              </div>
              <div className="rounded-3xl border border-border/70 bg-background/85 p-5">
                <p className="font-medium text-foreground">
                  {data.publishedEthicsCount} kasus etika sudah terlihat oleh siswa.
                </p>
                <p className="mt-1">
                  Kasus baru wajib punya ringkasan dan detail agar siswa pemula bisa mengikuti konteksnya.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              description: "Update publik yang sudah terlihat di dashboard siswa.",
            },
            {
              label: "Total modul",
        ...
        <Tabs defaultValue={defaultTab} className="gap-6">
          <div className="flex flex-col gap-4 rounded-[2rem] border border-border/70 bg-card/80 p-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              Pilih tab sesuai tugas. Setelah submit, dashboard akan kembali ke tab yang relevan.
            </div>
          </div>
          ...
          <TabsContent value="overview" className="space-y-6">
            <section className="grid gap-6 lg:grid-cols-3">
              {workflow.map((item) => {
                ...
                return (
                  <Card key={item.title} className="border-border/70 bg-card/92">
            ...
            <section className="grid gap-6 xl:grid-cols-[1fr_1fr]">
              <Card className="border-border/70 bg-card/92">
                <CardHeader className="space-y-3">
                  ...
                  <CardTitle className="text-2xl">Cek kualitas materi sebelum publish</CardTitle>
                  <CardDescription className="leading-7">
                    Prioritas untuk guru baru: pastikan modul punya tujuan belajar
                    jelas dan blok materi tidak kosong.
                  </CardDescription>
                </CardHeader>
                      ...
                      >
                        <div className="mb-2 flex flex-wrap items-center justify-between gap-3">
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            <Badge variant={module.is_published ? "secondary" : "outline"}>
                              {module.is_published ? "Published" : "Draft"}
                            </Badge>
                            <Badge variant="outline">{module.contents.length} blok</Badge>
                          </div>
                        </div>
              ...
              <Card className="border-border/70 bg-card/92">
                <CardHeader className="space-y-3">
                  ...
                  <CardTitle className="text-2xl">Pastikan setiap kasus punya detail</CardTitle>
                  <CardDescription className="leading-7">
          ...
          <TabsContent value="modules" className="space-y-6">
            <section id="teacher-modules" className="grid gap-6 xl:grid-cols-[1fr_1fr]">
              <Card className="border-border/70 bg-card/92">
                <CardHeader className="space-y-3">
                  <Badge variant="outline" className="w-fit">
                    Langkah 1: buat modul
                  </Badge>
                  <CardTitle className="text-2xl">Tulis kerangka modul sebelum mengisi blok</CardTitle>
                  <CardDescription className="leading-7">
                ...
                <CardContent>
                  <form action={createModuleAction} className="grid gap-4">
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        <label htmlFor="module-title" className="text-sm font-medium text-foreground">
                          Judul modul
                        </label>
                        <Input id="module-title" name="title" placeholder="Contoh: Dasar CRISPR" required />
                      </div>
                      <div className="space-y-2">
                        <label htmlFor="module-slug" className="text-sm font-medium text-foreground">
                          Slug opsional
                        </label>
                        <Input id="module-slug" name="slug" placeholder="dasar-crispr" />
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                      <div className="space-y-2">
                        ...
                        <Input id="track" name="track" placeholder="Bioteknologi Modern" />
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="duration" name="estimated_duration_minutes" type="number" defaultValue={60} min={1} />
                      </div>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="opening-narrative" className="text-sm font-medium text-foreground">
                        Narasi pembuka
                      </label>
                      <Textarea
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                      <label className="inline-flex items-center gap-2">
                        <input type="checkbox" name="is_featured" className="size-4 rounded border-border" />
                        Tampilkan sebagai modul unggulan
                      </label>
                      <label className="inline-flex items-center gap-2">
                        <input type="checkbox" name="is_published" className="size-4 rounded border-border" />
              ...
              <Card className="border-border/70 bg-card/92">
                <CardHeader className="space-y-3">
                  ...
                  <CardTitle className="text-2xl">Susun blok teks, gambar, video, tautan, atau PDF</CardTitle>
                  <CardDescription className="leading-7">
            ...
            <AdminModuleBlockManager modules={data.modules} initialModuleId={query.module} />
          </TabsContent>

          <TabsContent value="ethics" className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
            <Card className="border-border/70 bg-card/92">
              <CardHeader className="space-y-3">
                <Badge variant="outline" className="w-fit">
                  Langkah 3: posting kasus etika
                </Badge>
                <CardTitle className="text-2xl">Tulis ringkasan dan detail kasus etika</CardTitle>
                <CardDescription className="leading-7">
                  Ringkasan dipakai untuk kartu singkat. Detail kasus wajib diisi
                  untuk semua tipe sumber, termasuk PDF dan tautan.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form action={createEthicsCaseAction} className="grid gap-4">
                  <div className="space-y-2">
                    <label htmlFor="ethics-title" className="text-sm font-medium text-foreground">
                      Judul kasus
                    </label>
                    <Input id="ethics-title" name="title" placeholder="Privasi data genom" required />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="ethics-summary" className="text-sm font-medium text-foreground">
                      Ringkasan singkat
                    </label>
                    <Textarea
                      id="ethics-summary"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="ethics-detail" className="text-sm font-medium text-foreground">
                      Detail kasus etika
                    </label>
                    <Textarea
                      id="ethics-detail"
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      <label htmlFor="ethics-type" className="text-sm font-medium text-foreground">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="ethics-url" className="text-sm font-medium text-foreground">
                        URL sumber / PDF
                      </label>
                      <Input id="ethics-url" name="external_url" placeholder="https://..." />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input id="attachment" name="attachment" type="file" accept="application/pdf,image/png,image/jpeg,image/webp" />
                    <p className="text-xs leading-5 text-muted-foreground">
                      Untuk tipe PDF, unggah file PDF. Untuk tipe teks atau tautan, gunakan gambar sebagai cover opsional.
                    </p>
                  </div>
            ...
            <div className="grid gap-6">
              <Card className="border-border/70 bg-secondary/45">
                <CardHeader className="space-y-3">
                  ...
                  <CardTitle className="text-2xl">Sebelum publish kasus etika</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  {[
              ...
              <Card className="border-border/70 bg-card/92">
                <CardHeader className="space-y-3">
                  ...
                  <CardTitle className="text-2xl">Antrian update yang sudah disimpan</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  {data.ethicsCases.length > 0 ? (
        ...
        <section className="grid gap-6 xl:grid-cols-[1fr_1fr]">
          <Card className="border-border/70 bg-card/92">
            <CardHeader className="space-y-3">
              ...
              <CardTitle className="text-2xl">Konten modul di database</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {data.modules.length > 0 ? (
                  ...
                  >
                    <div className="mb-2 flex flex-wrap items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant="outline">{formatMinutes(module.estimated_duration_minutes)}</Badge>
                        <Badge variant="outline">{module.contents.length} blok</Badge>
                      </div>
                    </div>
                    <p className="text-sm leading-7 text-muted-foreground">
          ...
          <Card className="border-border/70 bg-card/92">
            <CardHeader className="space-y-3">
              ...
              <CardTitle className="text-2xl">Cara membaca status dashboard ini</CardTitle>
              <CardDescription className="leading-7">
